import { IAuthPayload, ISellerProject } from "@project/interfaces";
import { Response } from "express";

export const projectMockRequest = (
  sessionData: IJWT,
  body: ISellerProject,
...
export const projectMockResponse = (): Response => {
...
export const sellerProject: ISellerProject = {
